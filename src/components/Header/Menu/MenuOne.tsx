                ...
                <div className="container flex items-center justify-between h-20">
                    ...
                    <div className="menu-center-block h-full">
                        <ul className="menu-nav flex items-center xl:gap-2 h-full">
                            ...
                            <li className={`nav-item h-full flex items-center justify-center ${pathname.includes('/services/') ? 'active' : ''}`}><Link className="nav-link text-title flex items-center gap-1" href="#!">
                                <span>Services</span>
                                <span><Icon.CaretDown className="text-sm" /></span>
                            </Link>
                                <ul className="sub-nav">
                                    ...
                                    <li className={`sub-nav-item ${pathname === '/service/service-detail' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/service/service-detail">Services Detail</Link></li>
                                </ul>
                            </li>
                            <li className={`nav-item h-full flex items-center justify-center ${pathname.includes('/case-studies/') ? 'active' : ''}`}><Link className="nav-link text-title flex items-center gap-1" href="#!">
                                ...
                                <ul className="sub-nav">
                                    ...
                                    <li className={`sub-nav-item ${pathname === '/case-studies/case-studies-detail' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/case-studies/case-studies-detail">Case Studies Detail</Link></li>
                                </ul>
                            </li>
                            ...
                            <li className={`nav-item h-full flex items-center justify-center ${pathname.includes('/blog/') ? 'active' : ''}`}><Link className="nav-link text-title flex items-center gap-1" href="#!">
                                ...
                                <ul className="sub-nav">
                                    <li className={`sub-nav-item ${pathname === '/blog/blog-list' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/blog/blog-list-one">Blog List 1</Link></li>
                                    <li className={`sub-nav-item ${pathname === '/blog/blog-list' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/blog/blog-list-two">Blog List 2</Link></li>
                                    ...
                                    <li className={`sub-nav-item ${pathname === '/blog/blog-masonry' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/blog/blog-masonry">Blog Masonry</Link></li>
                                    <li className={`sub-nav-item ${pathname === '/blog/blog-detail-one' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/blog/blog-detail-one">Blog Detail 1</Link></li>
                                    <li className={`sub-nav-item ${pathname === '/blog/blog-detail-two' ? 'active' : ''}`}> <Link className="sub-nav-link font-medium" href="/blog/blog-detail-two">Blog Detail 2</Link></li>
                                </ul>
                            </li>
                            ...
                            <ul className="menu-nav-mobile h-full pt-1 pb-1">
                                ...
                                ><a className="nav-link-mobile flex items-center justify-between" href="#!">
                                    ...
                                    <ul className={`sub-nav-mobile ${openSubNavMobile === 4 ? 'open' : ''}`}>
                                        ...
                                        <li className="sub-nav-item pl-3 pr-3 pt-2 pb-2"> <Link className="sub-nav-link text-base" href="/case-studies/case-studies-detail">Case Studies Detail</Link></li>
                                    </ul>
                                </li>
                                ...
                                ><a className="nav-link-mobile flex items-center justify-between" href="#!">
                                    ...
                                    <ul className={`sub-nav-mobile ${openSubNavMobile === 6 ? 'open' : ''}`}>
                                        ...
                                        <li className="sub-nav-item pl-3 pr-3 pt-2 pb-2"> <Link className="sub-nav-link text-base" href="/blog/blog-masonry">Blog Masonry</Link></li>
