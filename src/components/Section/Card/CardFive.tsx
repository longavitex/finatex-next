        ...
        <div className="card-block lg:mt-[100px] sm:mt-16 mt-10">
            <div className="container">
                <div className="bg-img w-full">
                    <Image width={5000} height={5000} src="/images/component/phone1-home5.png" alt="" />
                    <Image width={5000} height={5000} src="/images/component/phone2-home5.png" alt="" />
                    <Image width={5000} height={5000} src="/images/component/phone3-home5.png" alt="" /></div>
