...
import CaseStudyTwo from "@/components/Section/CaseStudy/CaseStudyTwo"
...
export default function CaseStudyDetail({ params: { slug } }) {
    ...
    <>
      <div className="overflow-x-hidden">
        ...
        <div className="content">
          <BreadcrumbItem link="Case Studies" img="/images/banner/case-studies.png" title={foundPost.title} desc={foundPost.desc} />
          <div className="project-infor mt-[100px]">
            <div className="container">
              <div className="flex justify-between items-start gap-y-8">
                <div className="w-full lg:w-7/12">
                  <div className="heading3">E-Commerce Platform Development</div>
                  <div className="body3 text-secondary mt-4">Our objective for this project was to develop a comprehensive financial management platform that provided users with a centralized dashboard for managing their finances. We wanted to create a platform that was user-friendly, easy to navigate, and offered a range of features to help users track their spending, monitor their investments, and plan for their financial future. Our goal was to provide users with the tools and resources they need to make informed financial decisions and achieve their financial goals.</div>
                  <div className="count-number flex items-center justify-between mt-8 gap-5">
                    <div className="item">
                      <div className="count-block flex items-center">
                        <div className="counter heading4">2.3</div><span className="heading4">k</span>
                      </div>
                      <div className="body3 text-secondary mt-4">Business Setup Growth</div>
                    </div>
                    <div className="item">
                      <div className="count-block flex items-center">
                        <div className="counter heading4">1.77</div><span className="heading4">k</span>
                      </div>
                      <div className="body3 text-secondary mt-4">Business Problem Solving</div>
                    </div>
                    <div className="item">
                      <div className="count-block flex items-center">
                        <div className="counter heading4">246</div><span className="heading4">k</span>
                      </div>
                      <div className="body3 text-secondary mt-4">Passive income earners</div>
                    </div>
                  </div>
                </div>
                <div className="w-full lg:w-1/3">
                  <div className="rounded-xl bg-white box-shadow p-8 flex flex-col justify-between">
                    ...
                    <div className="infor-item flex items-center justify-between mt-8">
                      ...
                      <div className="body3 text-secondary">Maverick Nguyen</div>
                    </div>
              ...
              <div className="flex items-center gap-y-8">
                <div className="w-full lg:w-1/2 pr-[40px] flex flex-col justify-center">
                  ...
                  <div className="button-block mt-6">
                    <Link className="button-main bg-black hover:bg-blue text-white text-button w-fit rounded-lg flex items-center gap-2" href="contact-two.html">
                      <Icon.ArrowRight weight="bold" className="text-white rounded-xl" />
                      <span>start now</span>
                    </Link>
                  </div>
                </div>
                <div className="w-full lg:w-1/2 pl-[55px]">
                  <div className="bg-img w-full overflow-hidden rounded-2xl">
                    <img className="w-full h-full hover-scale block" src="/images/component/assessment.png" alt="" /></div>
                </div>
              </div>
            </div>
          </div>
